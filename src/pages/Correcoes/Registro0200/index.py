...
from src.pages.Correcoes.Registro0200.services.index import Adicionar0220Feature

def Corrigir0220Feature(Screen, ActiveCNPJ):
    ...
    LabelDescricao.setText('Corrigir cadastro - Adicionar 0220')
