...
from src.pages.Importar.cadastro_produtos.services.index import ImportCadastroProduto


def ImportarCadastroProdutosFeature(Screen, ActiveCNPJ):
    ...
    def SaveButtonClicked(Barra_Progesso):
        ...
        response = ImportCadastroProduto(Params)
    ...
    LabelDescricao.setText('Importar - Cadastro de produtos')
