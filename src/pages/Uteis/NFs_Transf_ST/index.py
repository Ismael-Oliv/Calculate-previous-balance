...
from src.pages.Uteis.NFs_Transf_ST.services.index import  FindXMlWithoutSt

def FindXMlWithoutStFeature(Screen, ActiveCNPJ):
    ...
    def ProcessButton(Barra_Progesso):
        ...
        if CompanyName:
            ...
            response = FindXMlWithoutSt(Params)
    ...
    def SelectOrigemPath(TXTOrigem):
        ...
        directory = QtWidgets.QFileDialog.getExistingDirectory(
            None, 'Selecione a pasta de XMLs:', '/', QtWidgets.QFileDialog.ShowDirsOnly)
    ...
    LabelDescricao.setText('Uteis - NFs de Transf. sem ST')
