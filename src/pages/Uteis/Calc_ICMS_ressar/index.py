...
from src.pages.Uteis.Calc_ICMS_ressar.services.index import CalcularICMSRessarcimento

def CalcICMSRessarFeature(Screen, ActiveCNPJ):
    ...
    def SelectOrigemPath(TXTOrigem):
        ...
        directory = QtWidgets.QFileDialog.getOpenFileName(None, "Open File", "/home", "Files (*.TXT *.txt)")
        TXTOrigem.setText(directory[0])
    ...
    LabelDescricao.setText('Uteis - Calcular ICMS Ressarcimento')
